  ...
  return (
    <AboutContainer>
      ...
      <ImgSectionsContainer>
        <p>Hello, we are Zest. We help our clients to stand out, enable <br /> them reach their communnication goals and make them like the digital word.</p>
        <ImgSection>
          <ImgContainer name='1'>
            <img srcSet={ `${img2} 600w, ${img3} 800w, ${img1} 1000w` } src={ img1 } alt='1'/>
        ...
        <ImgSection>
          ...
          <ImgContainer name='4'>
            <img src={ img4 } alt='4'/>
            <p>issey miyake \ <br />the ultimate issey miyake monograph</p>
          </ImgContainer>
        </ImgSection>
        <ImgSection>
          <ImgContainer name='5'>
